-- HISTORICAL DESIGN REFERENCE ONLY. DO NOT APPLY TO A CURRENT DATABASE.
-- Current schema truth: src/db/schema.ts and src/db/migrations/**.
-- V1 canonical logical schema for SQLite.
-- Implementations may translate this into Drizzle schema + migrations while preserving semantics.
